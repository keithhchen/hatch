...
| Repository test health | Local green | Dashboard 63/63 + production build；Commerce 44/44；Runtime 370/370；Playwright 64 total = 20 passed / 44 intentional project skips / 0 failed；Compose app/infra config、workflow YAML、Node syntax与 `git diff --check` 均通过。 |
