...
| --- | --- | --- |
| G01-source-trace | PASS | 33 source facts have exact excerpts and source paths |
...
| G10-prompt-purification | PASS | system prompt is 5594 chars; compression ratio 0.4358055468993456; first-person Creator voice matches []; duplicate normalized bullets 0 |
