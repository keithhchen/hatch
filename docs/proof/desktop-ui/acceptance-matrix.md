...
`Hatch_0.1.0_aarch64.dmg`（`sha256:1409366ac2703431db3f323a2a2cceccd61876d928547c503cd6856510aaef0e`，15,263,419 bytes）。它们不是可发布的 notarized artifact。正式发布必须在 CI 注入真实 Developer ID/Team ID，并完成签名、notarization、安装后重启和无 prompt 验收。
