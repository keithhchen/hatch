...
| 每窗口 Conversation、Workspace、draft、zoom、scroll、cursor 独立保存 | PARTIAL | native settings schema、account-scoped window context、renderer/native tests；URL conversation window routing | 三个并行真实窗口关闭/重开及 crash/restart E2E |
