...
`Hatch_0.1.0_aarch64.dmg`（`sha256:e4a14f07a3af3d30bcd4102e8682e6b71073e51ed88dbf5ca4f6177a5b9b11d4`）。它们不是可发布的 notarized artifact。正式发布必须在 CI 注入真实 Developer ID/Team ID，并完成签名、notarization、安装后重启和无 prompt 验收。
