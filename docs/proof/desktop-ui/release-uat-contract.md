...
publishable. Public macOS and Windows preview distribution is handled
separately by the OSS tag job in `desktop-ci.yml`; the same packages are
published to the public GitHub Release repository. Windows signed distribution remains
