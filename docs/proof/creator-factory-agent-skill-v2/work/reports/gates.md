...
| G10-prompt-purification | PASS | system prompt is 5983 chars; compression ratio 0.46611093798691183; first-person Creator voice matches []; duplicate normalized bullets 0 |
