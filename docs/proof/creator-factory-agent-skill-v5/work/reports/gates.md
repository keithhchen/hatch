...
| G10-prompt-purification | PASS | system prompt is 6929 chars; compression ratio 0.539809909629168; first-person Creator voice matches []; duplicate normalized bullets 0 |
