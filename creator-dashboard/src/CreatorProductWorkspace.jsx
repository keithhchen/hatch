...
import { Button, FormField, InlineAlert, Input, PageHeader, Select, Skeleton, StatusTag, Textarea } from "@hatch/ui";
import {
  getDistillationTask,
  getFactoryRun,
  getFactoryReview,
...
export function CreatorProductWorkspace({ token, request, productId, tab = "files", navigate, locale = "en", profile }) {
