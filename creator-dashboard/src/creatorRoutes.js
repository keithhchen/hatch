...
export function parseCreatorRoute(pathname) {
  ...
  if (segments[0] === "factory") return segments.length === 1
    ? { kind: "factory-index", section: "products" }
  ...
  if (segments[0] === "products") {
    ...
    if (segments[2] === "factory") return segments.length === 3
      ? { kind: "factory-agents", section: "products", productId }
      : { kind: "not-found", section: "products" };
