...
const PORTAL_MESSAGES = {
  en: {
    factoryLabel: "Creator Factory",
    factoryTitle: "Turn one method into one useful product.",
    factoryBody: "Hatch builds a candidate, asks for your reference answers, and keeps sealed answers out of every model-visible Corpus context.",
    factoryRuns: "Runs",
    refresh: "Refresh",
    noFactoryRuns: "No Factory runs yet.",
    newDistillation: "New distillation",
    createProductFirst: "Create a product first",
    createProductFirstBody: "Each Product has its own files. Create the Product, upload local files, then generate a version from that Product.",
    referenceAnswers: "Your reference answers",
    referenceAnswersBody: "Answer each generated question directly. Hatch—not another synthetic answer—will be judged against these answers.",
    questionBatchChanged: "The question batch changed",
    questionBatchChangedBody: "Your earlier answers were not submitted to the new batch. Copy anything useful; Hatch will never apply it automatically.",
    dismiss: "Dismiss",
    earlierAnswer: (number) => `Earlier answer ${number}`,
    copyAnswer: "Copy answer",
    clipboardUnavailable: "Clipboard access is unavailable. Select the answer text and copy it manually.",
    questionLabel: (number, prefix, question) => `${number}. ${prefix ? `${prefix} · ` : ""}${question}`,
    confirmSourceHypothesis: "Confirm a source hypothesis",
    sourceHypothesisPlaceholder: "Confirm, correct, refine, or reject this hypothesis; add the source if you know it.",
    deliverablePlaceholder: "Give the finished deliverable or decisive recommendation you would stand behind.",
    submitAllAnswers: "Submit all answers",
    factoryRunInProgress: "Factory run in progress",
    hatchAdvancingGraph: "Hatch is advancing the graph",
    noMonitoringAgent: "No monitoring agent is required. The worker will pause here automatically when it needs your answers.",
    candidateVersionPassed: (version) => `Candidate v${version} passed`,
    verifiedAgentCorpus: "Verified Agent Corpus",
    systemAsset: "System asset",
    bundlePassedNotPublished: "The complete bundle passed the Registry verifier. It has not been published; Creator approval remains separate.",
    creatorCorrectionRequired: "Creator correction is required",
    sealedEvaluationBoundary: "The sealed evaluation found a boundary case.",
    reviewKnownCases: "Review the known cases and confirm the correction loop; held-out content stays sealed.",
    openReview: "Open review",
    checkpointCannotRetry: "This checkpoint cannot be retried safely. Start a new run after correcting the source or configuration.",
    startAnotherRun: "Start another run",
    factoryStageExtractingEvidence: "Extracting evidence",
    factoryStageAwaitingCreatorAnswers: "Waiting for your answers",
    factoryStageCompilingCorpus: "Compiling the Corpus",
    factoryStageEvaluatingDevelopment: "Checking development cases",
    factoryStageEvaluatingRegression: "Running regression",
    factoryStageEvaluatingHeldout: "Running sealed held-out cases",
    factoryStageReviewRequired: "Needs your correction",
    factoryStageReady: "Candidate ready",
    factoryStageNeedsAttention: "Needs attention",
    factoryStageQueued: "Queued",
    factoryStageWorking: "Working",
    factoryStageNotStarted: "Not started",
    loadingCandidateReview: "Loading candidate review…",
    backToFactory: "Back to Factory",
    readyToRelease: "Ready to release",
    needsReview: "Needs review",
    knownCasesReviewed: "Known cases reviewed",
    needsYourReview: "Needs your review",
    blindCases: "Blind cases",
    blindCasesPassed: (passed, total) => `${passed} / ${total} passed`,
    questionsAnswersSealed: "Questions and answers stay sealed.",
    noKnownCasesYet: "No known cases yet",
    knownCasesWillAppear: "Known cases will appear here after the candidate has been evaluated.",
    creatorConfirmationRequired: "Creator confirmation required",
    generalizationCheck: "Generalization check",
    blindFailureBody: (count) => `${count} sealed case${count === 1 ? "" : "s"} failed. The case text, answer, and candidate output stay hidden until you confirm the correction loop.`,
    blindPassBody: (passed, total) => `${passed} / ${total} sealed cases passed. Held-out content is not included in the Corpus.`,
    heldoutCorrectionText: "Confirmed sealed failure; incorporate the Creator correction loop before re-evaluating.",
    heldoutCorrectionWhy: "The sealed case failed and must be promoted only after explicit Creator confirmation.",
    confirmStartCorrection: "Confirm and start correction",
    openReleasePreview: "Open Release preview",
    runtimeCorpusUnavailable: "The verified runtime Corpus is not available for this Candidate yet.",
    whatAgentWillReceive: "What the Agent will receive",
    immutableRuntimeAssets: "These are the complete immutable runtime assets bound to this Candidate. You can inspect every layer before release.",
    verifiedAt: (value) => `Verified ${value}`,
    evaluationAssetsSealed: "Evaluation assets remain sealed and are not runtime Corpus content.",
    knownCase: "Known case",
    yourReference: "Your reference",
    candidateOutput: "Candidate output",
    evaluationReported: "Evaluation reported",
    waitingForEvaluationReview: "Waiting for evaluation review",
    evaluationWrongBody: "You reported that the evaluation—not the Agent—may be wrong. This case is paused for evaluator calibration; it does not change the Agent or count as passed.",
    caseAlreadyHandled: "This case has already been handled. Its decision is preserved in the revision history.",
    decisionPreserved: "Decision preserved in revision history",
    candidateOutputAriaLabel: "Candidate output",
    whyHatchMadeCall: "Why Hatch made this call",
    whyCorrectBehavior: "Why is this the correct behavior?",
    whatEvaluationGotWrong: "What did the evaluation get wrong?",
    reportEvaluationIssue: "Report evaluation issue",
    submitCorrection: "Submit correction",
    correctThisAnswer: "Correct this answer",
    evaluationIsWrong: "Evaluation is wrong",
    questionIsInvalid: "Question is invalid",
    correctionHint: "This case failed. Correct the behavior or tell us the question is invalid.",
    passHint: "Confirm the behavior, correct it, or tell us the evaluation is wrong.",
    correctionDetailsRequired: "Add the corrected answer and why it is the right behavior.",
    evaluationDetailsRequired: "Explain what the evaluation got wrong.",
    verified: "Verified",
    accept: "Accept",
    overview: "Overview",
  ...
  zh: {
    factoryLabel: "Creator Factory",
    factoryTitle: "把一个方法变成一个有用的产品。",
    factoryBody: "Hatch 会生成候选版本，向你提问，并确保封存答案不会进入任何模型可见的 Corpus 上下文。",
    factoryRuns: "运行记录",
    refresh: "刷新",
    noFactoryRuns: "还没有 Factory 运行记录。",
    newDistillation: "新的提炼",
    createProductFirst: "请先创建产品",
    createProductFirstBody: "每个 Product 都有自己的文件。先创建 Product，上传本地文件，再从这个 Product 生成版本。",
    referenceAnswers: "你的参考答案",
    referenceAnswersBody: "直接回答每个生成的问题。Hatch 会根据这些答案判断，而不是使用另一份合成答案。",
    questionBatchChanged: "问题批次已变化",
    questionBatchChangedBody: "你之前的答案没有提交到新的批次。你可以复制有用的内容；Hatch 不会自动应用它们。",
    dismiss: "关闭",
    earlierAnswer: (number) => `之前的答案 ${number}`,
    copyAnswer: "复制答案",
    clipboardUnavailable: "剪贴板不可用。请选择答案文本并手动复制。",
    questionLabel: (number, prefix, question) => `${number}. ${prefix ? `${prefix} · ` : ""}${question}`,
    confirmSourceHypothesis: "确认来源假设",
    sourceHypothesisPlaceholder: "确认、修正、完善或拒绝这个假设；如果知道来源，请补充来源。",
    deliverablePlaceholder: "填写你愿意负责的最终交付物或关键建议。",
    submitAllAnswers: "提交全部答案",
    factoryRunInProgress: "Factory 正在运行",
    hatchAdvancingGraph: "Hatch 正在推进图谱",
    noMonitoringAgent: "不需要监控 Agent。需要你回答时，Worker 会自动在这里暂停。",
    candidateVersionPassed: (version) => `候选版本 v${version} 已通过`,
    verifiedAgentCorpus: "已验证的 Agent Corpus",
    systemAsset: "系统资产",
    bundlePassedNotPublished: "完整 bundle 已通过 Registry 验证，但还没有发布；Creator 批准仍是独立步骤。",
    creatorCorrectionRequired: "需要 Creator 修正",
    sealedEvaluationBoundary: "封存评估发现了一个边界案例。",
    reviewKnownCases: "请检查已知案例并确认修正循环；留出内容仍会保持封存。",
    openReview: "打开审核",
    checkpointCannotRetry: "这个检查点不能安全重试。请修正来源或配置后重新开始。",
    startAnotherRun: "开始另一次运行",
    factoryStageExtractingEvidence: "正在提取证据",
    factoryStageAwaitingCreatorAnswers: "等待你的答案",
    factoryStageCompilingCorpus: "正在编译 Corpus",
    factoryStageEvaluatingDevelopment: "正在检查开发案例",
    factoryStageEvaluatingRegression: "正在运行回归检查",
    factoryStageEvaluatingHeldout: "正在运行封存留出案例",
    factoryStageReviewRequired: "需要你的修正",
    factoryStageReady: "候选版本已准备好",
    factoryStageNeedsAttention: "需要处理",
    factoryStageQueued: "排队中",
    factoryStageWorking: "处理中",
    factoryStageNotStarted: "尚未开始",
    loadingCandidateReview: "正在加载候选版本审核…",
    backToFactory: "返回 Factory",
    readyToRelease: "可以发布",
    needsReview: "需要审核",
    knownCasesReviewed: "已审核的已知案例",
    needsYourReview: "需要你的审核",
    blindCases: "盲测案例",
    blindCasesPassed: (passed, total) => `${passed} / ${total} 已通过`,
    questionsAnswersSealed: "问题和答案保持封存。",
    noKnownCasesYet: "还没有已知案例",
    knownCasesWillAppear: "候选版本评估完成后，已知案例会显示在这里。",
    creatorConfirmationRequired: "需要 Creator 确认",
    generalizationCheck: "泛化检查",
    blindFailureBody: (count) => `${count} 个封存案例失败。确认修正循环前，案例文本、答案和候选输出都会保持隐藏。`,
    blindPassBody: (passed, total) => `${passed} / ${total} 个封存案例已通过。留出内容不会进入 Corpus。`,
    heldoutCorrectionText: "已确认封存案例失败；请纳入 Creator 修正循环后再重新评估。",
    heldoutCorrectionWhy: "封存案例失败，必须在 Creator 明确确认后才能进入修正流程。",
    confirmStartCorrection: "确认并开始修正",
    openReleasePreview: "打开发布预览",
    runtimeCorpusUnavailable: "这个 Candidate 的已验证运行时 Corpus 目前不可用。",
    whatAgentWillReceive: "Agent 将接收什么",
    immutableRuntimeAssets: "这些是绑定到 Candidate 的完整不可变运行时资产。发布前可以检查每一层。",
    verifiedAt: (value) => `验证于 ${value}`,
    evaluationAssetsSealed: "评估资产保持封存，不属于运行时 Corpus 内容。",
    knownCase: "已知案例",
    yourReference: "你的参考答案",
    candidateOutput: "候选输出",
    evaluationReported: "评估报告",
    waitingForEvaluationReview: "等待评估审核",
    evaluationWrongBody: "你报告评估可能有误，而不是 Agent 有误。这个案例会暂停等待评估校准；它不会改变 Agent，也不会计为通过。",
    caseAlreadyHandled: "这个案例已经处理过，决定会保留在版本历史中。",
    decisionPreserved: "决定已保留在版本历史中",
    candidateOutputAriaLabel: "候选输出",
    whyHatchMadeCall: "Hatch 为什么这样判断",
    whyCorrectBehavior: "为什么这是正确的行为？",
    whatEvaluationGotWrong: "评估错在哪里？",
    reportEvaluationIssue: "报告评估问题",
    submitCorrection: "提交修正",
    correctThisAnswer: "修正这个答案",
    evaluationIsWrong: "评估有误",
    questionIsInvalid: "问题无效",
    correctionHint: "这个案例失败了。请修正行为，或告诉我们这个问题无效。",
    passHint: "确认这个行为、修正它，或告诉我们评估有误。",
    correctionDetailsRequired: "请填写修正后的答案，并说明为什么这是正确的行为。",
    evaluationDetailsRequired: "请说明评估错在哪里。",
    verified: "已验证",
    accept: "接受",
    overview: "概览",
    testImprove: "测试与改进",
  ...
  ja: {
    factoryLabel: "Creator Factory",
    factoryTitle: "一つの方法を、役立つ一つのプロダクトにします。",
    factoryBody: "Hatch は候補を作り、あなたの基準回答を尋ね、封印された回答をモデルから見える Corpus に入れません。",
    factoryRuns: "実行履歴",
    refresh: "更新",
    noFactoryRuns: "Factory の実行はまだありません。",
    newDistillation: "新しい抽出",
    createProductFirst: "まずプロダクトを作成してください",
    createProductFirstBody: "各 Product には専用のファイルがあります。Product を作成し、ローカルファイルをアップロードしてから、その Product からバージョンを生成します。",
    referenceAnswers: "あなたの基準回答",
    referenceAnswersBody: "生成された質問に直接答えてください。Hatch は別の合成回答ではなく、これらの回答を基準に評価します。",
    questionBatchChanged: "質問のバッチが変わりました",
    questionBatchChangedBody: "以前の回答は新しいバッチに送信されませんでした。必要な内容はコピーできます。Hatch が自動適用することはありません。",
    dismiss: "閉じる",
    earlierAnswer: (number) => `以前の回答 ${number}`,
    copyAnswer: "回答をコピー",
    clipboardUnavailable: "クリップボードを利用できません。回答文を選択して手動でコピーしてください。",
    questionLabel: (number, prefix, question) => `${number}. ${prefix ? `${prefix} · ` : ""}${question}`,
    confirmSourceHypothesis: "情報源の仮説を確認",
    sourceHypothesisPlaceholder: "この仮説を確認、修正、詳しくするか、取り消してください。分かる場合は情報源を追加します。",
    deliverablePlaceholder: "責任を持って示せる完成した成果物、または決定的な提案を入力してください。",
    submitAllAnswers: "回答をすべて送信",
    factoryRunInProgress: "Factory を実行中",
    hatchAdvancingGraph: "Hatch がグラフを進めています",
    noMonitoringAgent: "監視 Agent は必要ありません。回答が必要になると Worker がここで自動的に停止します。",
    candidateVersionPassed: (version) => `候補 v${version} に合格しました`,
    verifiedAgentCorpus: "検証済み Agent Corpus",
    systemAsset: "システムアセット",
    bundlePassedNotPublished: "完全な bundle は Registry の検証に合格しました。まだ公開されておらず、Creator の承認は別に必要です。",
    creatorCorrectionRequired: "Creator の修正が必要です",
    sealedEvaluationBoundary: "封印された評価で境界ケースが見つかりました。",
    reviewKnownCases: "既知のケースを確認し、修正ループを確定してください。保留された内容は封印されたままです。",
    openReview: "レビューを開く",
    checkpointCannotRetry: "このチェックポイントは安全に再試行できません。ソースまたは設定を修正して新しい実行を開始してください。",
    startAnotherRun: "別の実行を開始",
    factoryStageExtractingEvidence: "証拠を抽出中",
    factoryStageAwaitingCreatorAnswers: "回答を待機中",
    factoryStageCompilingCorpus: "Corpus を構築中",
    factoryStageEvaluatingDevelopment: "開発ケースを確認中",
    factoryStageEvaluatingRegression: "回帰を実行中",
    factoryStageEvaluatingHeldout: "封印されたホールドアウトケースを実行中",
    factoryStageReviewRequired: "修正が必要です",
    factoryStageReady: "候補の準備完了",
    factoryStageNeedsAttention: "対応が必要です",
    factoryStageQueued: "待機中",
    factoryStageWorking: "処理中",
    factoryStageNotStarted: "未開始",
    loadingCandidateReview: "候補レビューを読み込み中…",
    backToFactory: "Factory に戻る",
    readyToRelease: "公開できます",
    needsReview: "レビューが必要です",
    knownCasesReviewed: "レビュー済みの既知ケース",
    needsYourReview: "あなたのレビューが必要です",
    blindCases: "ブラインドケース",
    blindCasesPassed: (passed, total) => `${passed} / ${total} 合格`,
    questionsAnswersSealed: "質問と回答は封印されています。",
    noKnownCasesYet: "既知のケースはまだありません",
    knownCasesWillAppear: "候補の評価が完了すると、既知のケースがここに表示されます。",
    creatorConfirmationRequired: "Creator の確認が必要です",
    generalizationCheck: "汎化チェック",
    blindFailureBody: (count) => `${count} 件の封印ケースが失敗しました。修正ループを確認するまで、ケース文、回答、候補の出力は非表示です。`,
    blindPassBody: (passed, total) => `${passed} / ${total} 件の封印ケースに合格しました。ホールドアウト内容は Corpus に含まれません。`,
    heldoutCorrectionText: "封印された失敗を確認しました。再評価の前に Creator の修正ループを反映します。",
    heldoutCorrectionWhy: "封印ケースが失敗したため、Creator の明示的な確認後にのみ修正へ進めます。",
    confirmStartCorrection: "確認して修正を開始",
    openReleasePreview: "リリースプレビューを開く",
    runtimeCorpusUnavailable: "この Candidate の検証済みランタイム Corpus はまだ利用できません。",
    whatAgentWillReceive: "Agent が受け取るもの",
    immutableRuntimeAssets: "これは Candidate に紐づく完全な不変ランタイムアセットです。公開前にすべてのレイヤーを確認できます。",
    verifiedAt: (value) => `${value} に検証済み`,
    evaluationAssetsSealed: "評価アセットは封印され、ランタイム Corpus の内容にはなりません。",
    knownCase: "既知のケース",
    yourReference: "あなたの基準回答",
    candidateOutput: "候補の出力",
    evaluationReported: "評価の報告",
    waitingForEvaluationReview: "評価レビューを待機中",
    evaluationWrongBody: "評価側が Agent ではなく誤っている可能性を報告しました。このケースは評価者の調整まで停止します。Agent は変わらず、合格にも数えません。",
    caseAlreadyHandled: "このケースはすでに処理済みです。判断は改訂履歴に保存されています。",
    decisionPreserved: "判断は改訂履歴に保存されています",
    candidateOutputAriaLabel: "候補の出力",
    whyHatchMadeCall: "Hatch がこの判断をした理由",
    whyCorrectBehavior: "なぜこれが正しい動作ですか？",
    whatEvaluationGotWrong: "評価のどこが間違っていましたか？",
    reportEvaluationIssue: "評価の問題を報告",
    submitCorrection: "修正を送信",
    correctThisAnswer: "この回答を修正",
    evaluationIsWrong: "評価が間違っています",
    questionIsInvalid: "質問が無効です",
    correctionHint: "このケースは失敗しました。動作を修正するか、質問が無効だと伝えてください。",
    passHint: "動作を確認するか、修正するか、評価が間違っていると伝えてください。",
    correctionDetailsRequired: "修正後の回答と、それが正しい動作である理由を入力してください。",
    evaluationDetailsRequired: "評価のどこが間違っていたか説明してください。",
    verified: "検証済み",
    accept: "承認",
    overview: "概要",
    testImprove: "テストと改善",
