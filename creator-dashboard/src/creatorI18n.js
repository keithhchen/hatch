const MESSAGES = {
  en: {
    ...
    sourceNote: "PDF, DOCX, XLSX, CSV, TXT, Markdown, JSON and HTML become Markdown. Image files keep their visual input for the configured Factory provider.",
  ...
  zh: {
    ...
    sourceNote: "PDF、DOCX、XLSX、CSV、TXT、Markdown、JSON 和 HTML 会转换为 Markdown。图片会保留视觉输入，并交由当前配置的 Factory provider 处理。",
  ...
  ja: {
    ...
    sourceNote: "PDF、DOCX、XLSX、CSV、TXT、Markdown、JSON、HTML は Markdown に変換されます。画像ファイルは視覚入力を保持し、設定された Factory provider が処理します。",
