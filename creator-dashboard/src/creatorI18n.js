const MESSAGES = {
  en: {
    ...
    deleteProductConfirm: "Delete this unpublished Product? This cannot be undone.",
    ...
    ready: "Ready",
    removeFile: "Remove",
    confirmRemoveFile: "Remove this file from the Product? It will be hidden from future runs, while its stored artifact remains available for audit.",
    fileRemoved: "File removed from the active Product files.",
    ...
    heldoutCorrectionRequired: "Describe the correction and why it is required before continuing.",
    heldoutCorrectionFailed: "Unable to start the held-out correction version.",
    ...
    productOverviewBody: "Set the product name and the promise a customer should understand at a glance.",
    saveProductDetails: "Save changes",
    productDetailsSaved: "Product details saved.",
    openFactory: "Open Factory",
    products: "Products",
    browse: "Browse",
    currentVersion: "Current version",
    version: (number, status) => `Version ${number} · ${status}`,
    sourceNote: "PDF and Office (Word, Excel, PowerPoint) documents are converted to Markdown. Text files are stored as Markdown too. Images are not supported yet.",
    ...
    ,factoryBuildPathTitle: "How your Agent gets made"
    ,factoryBuildPathBody: "You provide the source material and set the standard. Hatch does the building in between."
    ,factoryLedByYou: "You lead"
    ,factoryLedByHatch: "Hatch leads"
    ,factoryStepUpload: "Upload source material"
    ,factoryStepUploadBody: "Bring the work, examples, and material behind your method."
    ,factoryStepVoice: "Voice interview"
    ,factoryStepVoiceBody: "Hatch interviews you to uncover how you decide, including trade-offs and edge cases."
    ,factoryStepBuild: "Build your Agent"
    ,factoryStepBuildBody: "Hatch turns the evidence into an Agent that can do the work."
    ,factoryStepCase: "Build a client case"
    ,factoryStepCaseBody: "Hatch creates a realistic situation that demands your expert judgment."
    ,factoryStepEvaluate: "Evaluate the result"
    ,factoryStepEvaluateBody: "Run the Agent, judge its work, and correct what is not you."
    ...
    ,zeroProductRealWork: "We help turn the work you normally do for one client at a time into an Agent that can do real work for each person."
    ,zeroProductNotChatbot: "Not a chatbot that sounds like you."
    ,zeroProductTest: "An Agent whose work makes you say: “Yes — that’s what I would have done.”"
  ...
  zh: {
    ...
    placedAt: "下单时间",
    deleteProduct: "删除产品",
    deleteProductConfirm: "删除这个未发布的产品？此操作无法撤销。",
    ...
    ready: "已准备好",
    removeFile: "移除",
    confirmRemoveFile: "从这个产品中移除这个文件？它会从后续运行中隐藏，但保存的文件仍会保留用于审计。",
    fileRemoved: "文件已从当前产品文件列表中移除。",
    ...
    heldoutCorrectionRequired: "请先描述修正内容和原因，再继续。",
    heldoutCorrectionFailed: "无法启动留出评估修正版本。",
    correctionRequired: "需要修正",
    sealed: "已密封",
    whatProductDelivers: "你的产品交付什么？",
    saveProductPromise: "保存产品承诺",
    productPromiseSaved: "产品承诺已保存。",
    productOverview: "产品概览",
    editProductDetails: "编辑产品信息",
    productOverviewBody: "设置产品名称，以及用户一眼就应该理解的产品承诺。",
    saveProductDetails: "保存修改",
    productDetailsSaved: "产品信息已保存。",
    openFactory: "打开 Factory",
    products: "产品",
    browse: "浏览",
    currentVersion: "当前版本",
    version: (number, status) => `版本 ${number} · ${status}`,
    sourceNote: "PDF 和 Office（Word、Excel、PowerPoint）文档会转换为 Markdown，文本文件也会按 Markdown 保存。暂不支持图片。",
    ...
    ,factoryBuildPathTitle: "你的 Agent 将如何诞生"
    ,factoryBuildPathBody: "你提供资料并决定标准，Hatch 负责完成中间的构建工作。"
    ,factoryLedByYou: "你主导"
    ,factoryLedByHatch: "Hatch 主导"
    ,factoryStepUpload: "上传资料"
    ,factoryStepUploadBody: "提供能展现你的工作、案例和方法的原始材料。"
    ,factoryStepVoice: "语音访谈"
    ,factoryStepVoiceBody: "Hatch 通过访谈理解你如何判断，包括取舍、边界与例外。"
    ,factoryStepBuild: "构建 Agent"
    ,factoryStepBuildBody: "Hatch 把收集到的依据变成一个真正能工作的 Agent。"
    ,factoryStepCase: "构建客户案例"
    ,factoryStepCaseBody: "Hatch 创建一个需要你专业判断的真实客户情境。"
    ,factoryStepEvaluate: "检查结果"
    ,factoryStepEvaluateBody: "运行 Agent、判断它的工作，并纠正任何不像你的地方。"
    ...
    ,zeroProductRealWork: "我们把你原本需要逐个为客户完成的工作，做成一个能为每个人真正工作的 Agent。"
    ,zeroProductNotChatbot: "它不是一个模仿你说话的 chatbot。"
    ,zeroProductTest: "它交出的工作，应该让你说：“对，这就是我会做的。”"
  ...
  ja: {
    ...
    published: "公開済み",
    placedAt: "注文日時",
    deleteProduct: "プロダクトを削除",
    deleteProductConfirm: "この未公開プロダクトを削除しますか？この操作は取り消せません。",
    ...
    ready: "準備完了",
    removeFile: "削除",
    confirmRemoveFile: "このファイルをプロダクトから削除しますか？今後の実行からは非表示になりますが、監査用の保存 artifact は残ります。",
    fileRemoved: "ファイルをアクティブなプロダクト一覧から削除しました。",
    ...
    heldoutCorrectionRequired: "続行する前に修正内容と理由を入力してください。",
    heldoutCorrectionFailed: "ホールドアウト修正版を開始できませんでした。",
    correctionRequired: "修正が必要",
    sealed: "封印済み",
    whatProductDelivers: "プロダクトは何を届けますか？",
    saveProductPromise: "プロダクトの約束を保存",
    productPromiseSaved: "プロダクトの約束を保存しました。",
    productOverview: "プロダクト概要",
    editProductDetails: "プロダクト情報を編集",
    productOverviewBody: "プロダクト名と、顧客が一目で理解できる約束を設定します。",
    saveProductDetails: "変更を保存",
    productDetailsSaved: "プロダクト情報を保存しました。",
    openFactory: "Factory を開く",
    products: "プロダクト",
    browse: "参照",
    currentVersion: "現在のバージョン",
    version: (number, status) => `バージョン ${number} · ${status}`,
    sourceNote: "PDF と Office（Word、Excel、PowerPoint）文書は Markdown に変換され、テキストも Markdown として保存されます。画像はまだ対応していません。",
    ...
    ,factoryBuildPathTitle: "Agent ができるまで"
    ,factoryBuildPathBody: "あなたが資料と基準を示し、その間の構築を Hatch が担います。"
    ,factoryLedByYou: "あなたが主導"
    ,factoryLedByHatch: "Hatch が主導"
    ,factoryStepUpload: "資料をアップロード"
    ,factoryStepUploadBody: "あなたの仕事、事例、方法が伝わる元資料を追加します。"
    ,factoryStepVoice: "音声インタビュー"
    ,factoryStepVoiceBody: "Hatch が判断の仕方、トレードオフ、例外までインタビューします。"
    ,factoryStepBuild: "Agent を構築"
    ,factoryStepBuildBody: "Hatch が根拠を、実際に仕事のできる Agent に変えます。"
    ,factoryStepCase: "顧客ケースを構築"
    ,factoryStepCaseBody: "Hatch が専門的判断を必要とする現実的な顧客状況を作ります。"
    ,factoryStepEvaluate: "結果を評価"
    ,factoryStepEvaluateBody: "Agent を実行し、仕事を評価して、あなたらしくない部分を修正します。"
    ...
    ,zeroProductRealWork: "これまで一人ずつのクライアントに提供してきた仕事を、一人ひとりのために実際の仕事をする Agent に変えます。"
    ,zeroProductNotChatbot: "あなたらしく話すだけの chatbot ではありません。"
    ,zeroProductTest: "成果を見たあなたが「そう、私ならこうする」と言える Agent です。"
...
const PORTAL_MESSAGES = {
  en: {
    ...
    resolveFailedCriticalCases: "Resolve every failed critical case in a new version.",
  ...
  zh: {
    ...
    resolveFailedCriticalCases: "请在新的版本中解决所有失败的关键案例。",
