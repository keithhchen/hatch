...
1. Load this complete Skill before reading, creating, or editing a Word document. For a chat attachment, read the managed local file identified in the committed message through LocalRunner; the upload is a file reference, not extracted document text. Use the Skill reader to inspect its contents.
