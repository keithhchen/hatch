...
async function handleRuntimeSocket(
  ...
  // This is deliberately generated by the Runtime, not derived from
  // installation_id. A single Desktop installation may have several windows;
  // each WebSocket owns a distinct executor lease and cannot impersonate a
  // sibling window by reusing a client-provided identifier.
