...
FIXTURE = ROOT / "fixtures/creator-factory/maya-signal-resume"
...
class FactoryTests(unittest.TestCase):
    ...
    def test_complete_build_and_private_boundary(self):
        ...
        self.assertEqual(summary["source_facts"], 17)
        self.assertEqual(summary["derived_rules"], 6)
        ...
        self.assertEqual(len(traces), 31)
    ...
    def test_missing_annotation_fails(self):
        ...
        del plan["claim_annotations"]["S-COURSE-001"]
